...
func DefaultPermissionsGenerator(db *gorm.DB) {
	var permissions = []model.Permission{
		...
		{PermissionName: "通过项目ID获取路径信息", MenuName: "project", PermissionPath: "/api/project/path"},
		{PermissionName: "通过用户ID获取绑定的项目", MenuName: "project", PermissionPath: "/api/project/userId"},
		{PermissionName: "获取登陆用户绑定的项目", MenuName: "project", PermissionPath: "/api/project/get"},
